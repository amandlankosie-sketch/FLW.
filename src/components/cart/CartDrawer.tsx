          ...
          >
            ...
            {items.length === 0 ? (
              ...
              <>
                          ...
                          <div className="flex items-center justify-between mt-auto pt-2">
                            ...
                            <div className="flex items-center border border-charcoal/15">
                              <button
                                ...
                                className="w-8 h-8 flex items-center justify-center text-charcoal/60 hover:bg-charcoal/5 transition-colors duration-200"
                                aria-label={`Decrease quantity of ${item.productName}`}
                              >
                                <Minus size={14} strokeWidth={2} />
                              </button>
                              <span className="w-8 text-center text-sm font-display font-medium text-charcoal">
                                {item.quantity}
                              </span>
                              <button
                                onClick={() => updateQuantity(item.key, item.quantity + 1)}
                ...
                {/* Footer */}
                <div className="px-6 py-5 border-t border-charcoal/10 bg-cream-light">
