...
export default function Button({
  ...
  const base =
    "inline-flex items-center justify-center gap-2 px-7 py-3.5 text-sm font-medium tracking-wide font-display transition-all duration-300 ease-out rounded-none active:scale-[0.97] disabled:opacity-50 disabled:pointer-events-none";
